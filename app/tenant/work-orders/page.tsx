  ...
  return (
    <div className="space-y-12">
      <div className="flex items-center justify-between">
        ...
        <Link href="/tenant/work-orders/new" className="btn-primary">
          New Request
        </Link>
      </div>
          ...
          <ul>
            {orders.map((o) => {
              ...
              return (
                <li
                  key={o.id}
                  className="flex items-center gap-8 px-8 py-5 border-b border-line last:border-0 group hover:bg-stone-50 transition-colors"
                >
